...
export function Product(props: { children?: ComponentChildren }) {
  return (
      ...
      <div class="space-y-4">
        <div class="rounded-xl overflow-hidden bg-white p-6 shadow-sm">
          <div class="relative">
            ...
            <img src="https://images.unsplash.com/photo-1567306226416-28f0efdc88ce?q=80&w=1200&auto=format&fit=crop" alt="Plums" class="w-full h-96 object-cover rounded-lg" />
          </div>
          <div class="mt-4 flex gap-3 items-center">
            <div class="w-16 h-16 rounded-md border p-1 flex items-center justify-center bg-white">
              <img src="https://images.unsplash.com/photo-1567306226416-28f0efdc88ce?q=80&w=400&auto=format&fit=crop" alt="thumb" class="w-full h-full object-cover rounded-sm" />
            </div>
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm">
          ...
          <p class="text-sm text-gray-600 leading-relaxed">Fresh, juicy plums sourced from local orchards. Packed and shipped within hours to preserve taste and quality. Ideal for snacking and desserts.</p>
        </div>
      </div>
      ...
      <aside class="sticky top-6">
          ...
          <div class="mt-4 flex items-end gap-4">
            ...
            <div class="ml-auto text-right">
              <button aria-label="Add to wishlist" class="p-2 rounded-md border hover:bg-gray-50">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-pink-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 18.656 3.172 11.83a4 4 0 010-5.656z"/></svg>
              </button>
            </div>
          </div>
        ...
        <div class="mt-6 bg-white rounded-xl p-4 shadow-sm">
          <button aria-expanded="false" class="w-full flex items-center justify-between py-2 px-1" id="toggleDetails">
            ...
            <svg id="chev" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06-.02L10 10.88l3.71-3.69a.75.75 0 111.06 1.06l-4.24 4.22a.75.75 0 01-1.06 0L5.25 8.25a.75.75 0 01-.02-1.06z" clip-rule="evenodd"/></svg>
          </button>
